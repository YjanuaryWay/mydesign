...
!function (r) {
    ...
    var t = function (r, t, e, n) { var o = y(e, t); o.addData(r), o.make(), n = n || 0; var i = o.getModuleCount(), a = o.getModuleCount() + 2 * n, u = function (r, t) { return r -= n, t -= n, 0 > r || r >= i || 0 > t || t >= i ? !1 : o.isDark(r, t); }, f = function (r, t, e, n) { var o = this.isDark, i = 1 / a; this.isDark = function (a, u) { var f = u * i, l = a * i, c = f + i, g = l + i; return o(a, u) && (r > c || f > e || t > g || l > n); }; }; this.text = r, this.level = t, this.version = e, this.moduleCount = a, this.isDark = u, this.addBlank = f; }, e = function () { var r = document.createElement("canvas"); return !(!r.getContext || !r.getContext("2d")); }(), n = "[object Opera]" !== Object.prototype.toString.call(window.opera), o = function (r, e, n, o, i) {
    ...
    }, v = function (t) { var e = r("<canvas/>").attr("width", t.size).attr("height", t.size); return h(e, t); }, d = function (t) { return r("<img/>").attr("src", v(t)[0].toDataURL("image/png")); }, w = function (t) {
        ...
        return v;
    }, m = function (r) { return e && "canvas" === r.render ? v(r) : e && "image" === r.render ? d(r) : w(r); }, T = { render: "canvas", minVersion: 1, maxVersion: 40, ecLevel: "L", left: 0, top: 0, size: 200, fill: "#000", background: null, text: "no text", radius: 0, quiet: 0, mode: 0, mSize: .1, mPosX: .5, mPosY: .5, label: "no label", fontname: "sans", fontcolor: "#000", image: null };
    r.fn.qrcode = function (t) { var e = r.extend({}, T, t); return this.each(function () { "canvas" === this.nodeName.toLowerCase() ? h(this, e) : r(this).append(m(e)); }); };
    var y = function () {
        function r(t, e) {
            ...
            return o.get = function (r) { return n[r]; }, o.getLength = function () { return n.length; }, o.multiply = function (t) {
        ...
        var t = function (t, e) {
            ...
            return m.addData = function (r) { var t = l(r); w.push(t), d = null; }, m.isDark = function (r, t) {
                if (0 > r || r >= h || 0 > t || t >= h)
                    throw new Error(r + "," + t);
                return s[r][t];
            }, m.getModuleCount = function () { return h; }, m.make = function () { T(!1, p()); }, m.createTableTag = function (r, t) {
        ...
        var e = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 }, n = { L: 1, M: 0, Q: 3, H: 2 }, o = { PATTERN000: 0, PATTERN001: 1, PATTERN010: 2, PATTERN011: 3, PATTERN100: 4, PATTERN101: 5, PATTERN110: 6, PATTERN111: 7 }, i = function () {
            ...
            return f.getBCHTypeInfo = function (r) {
                ...
                for (var t = r << 12; l(t) - l(i) >= 0;)
                    t ^= i << l(t) - l(i);
                return r << 12 | t;
            }, f.getPatternPosition = function (r) { return t[r - 1]; }, f.getMaskFunction = function (r) {
                switch (r) {
                    case o.PATTERN000: return function (r, t) { return 0 == (r + t) % 2; };
                    case o.PATTERN001: return function (r) { return 0 == r % 2; };
                    case o.PATTERN010: return function (r, t) { return 0 == t % 3; };
                    case o.PATTERN011: return function (r, t) { return 0 == (r + t) % 3; };
                    case o.PATTERN100: return function (r, t) { return 0 == (Math.floor(r / 2) + Math.floor(t / 3)) % 2; };
                    case o.PATTERN101: return function (r, t) { return 0 == r * t % 2 + r * t % 3; };
                    case o.PATTERN110: return function (r, t) { return 0 == (r * t % 2 + r * t % 3) % 2; };
                    case o.PATTERN111: return function (r, t) { return 0 == (r * t % 3 + (r + t) % 2) % 2; };
            ...
            return e.getBuffer = function () { return r; }, e.get = function (t) { var e = Math.floor(t / 8); return 1 == (1 & r[e] >>> 7 - t % 8); }, e.put = function (r, t) {
                for (var n = 0; t > n; n += 1)
                    e.putBit(1 == (1 & r >>> t - n - 1));
            }, e.getLengthInBits = function () { return t; }, e.putBit = function (e) { var n = Math.floor(t / 8); r.length <= n && r.push(0), e && (r[n] |= 128 >>> t % 8), t += 1; }, e;
        }, l = function (r) {
            var n = e.MODE_8BIT_BYTE, o = t.stringToBytes(r), i = {};
            return i.getMode = function () { return n; }, i.getLength = function () { return o.length; }, i.write = function (r) {
                for (var t = 0; t < o.length; t += 1)
                    r.put(o[t], 8);
            }, i;
        }, c = function () {
            var r = new Array, t = {};
            return t.writeByte = function (t) { r.push(255 & t); }, t.writeShort = function (r) { t.writeByte(r), t.writeByte(r >>> 8); }, t.writeBytes = function (r, e, n) {
                e = e || 0, n = n || r.length;
                for (var o = 0; n > o; o += 1)
                    t.writeByte(r[o + e]);
            ...
            }, t.toByteArray = function () { return r; }, t.toString = function () {
                var t = "";
                t += "[";
                for (var e = 0; e < r.length; e += 1)
                    e > 0 && (t += ","), t += r[e];
